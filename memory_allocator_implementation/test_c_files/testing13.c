...
int main() {
   ...
   init_allocator(virtual_heap, 8, 3);
   virtual_info(virtual_heap);
   printf("\n");
   virtual_malloc(virtual_heap, 128);
   virtual_info(virtual_heap);
   printf("\n");
   virtual_realloc(virtual_heap, (((struct handler*)virtual_heap)->data_structures)->address, 8);
   virtual_info(virtual_heap);
   printf("\n");
   virtual_realloc(virtual_heap, (((struct handler*)virtual_heap)->data_structures)->address, 256);
   virtual_info(virtual_heap);
   printf("\n");
