...
int main() {
   ...
   virtual_info(virtual_heap);
   printf("\n");
   virtual_realloc(virtual_heap, ((((struct handler*)virtual_heap)->data_structures)->next)->address, 256);
   virtual_info(virtual_heap);
   printf("\n");
   virtual_free(virtual_heap, (((struct handler*)virtual_heap)->data_structures)->address);
   virtual_info(virtual_heap);
   printf("\n");
   virtual_realloc(virtual_heap, ((((struct handler*)virtual_heap)->data_structures)->next)->address, 1024);
   virtual_info(virtual_heap);
